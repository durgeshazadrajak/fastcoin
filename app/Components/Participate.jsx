          ...
          <Row className="justify-content-between align-items-center">
            <Col lg="5" md="5">
              <div className="coinbox">
                ...
                <div className="d-flex align-items-center justify-content-around">
                  <p className="mb-0">
                    <i className="bi bi-check2"></i> Transaction Completed
                  </p>
                  <span>9:40 AM</span>
                </div>
            ...
            <Col lg="6" md="6">
              ...
              <Link href="" className="btn btn-light w-75 mb-5">
                Invest Now & Grow with us <i className="bi bi-arrow-up-right"></i>
              </Link>
            </Col>
          </Row>
        </Container>
          ...
          <Row className="justify-content-between align-items-center">
            ...
            <Col lg="6" md="6">
              ...
              <Link href="" className="btn btn-warning ">
                Download App <i className="bi bi-arrow-up-right"></i>
              </Link>
            </Col>
          </Row>
        </Container>
